...
class ReviewForm(FlaskForm):
    ...
    rating = IntegerField('ratings', validators=[DataRequired("Please give a rating"), NumberRange(
        min=1, max=5, message='Number must be between 1 and 5')])
    review = StringField('reviews', validators=[DataRequired("Please leave a review"), Length(
