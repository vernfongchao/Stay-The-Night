...
def seed_reviews():
    ...
    db.session.add_all([review10, review11, review12])
    db.session.add_all([review13, review14, review15])
    db.session.add_all([review16, review17, review18])
    # db.session.add_all([review19, review20, review21])
    db.session.add_all([review22, review23, review24])
    db.session.commit()
